...
3. **Versioning**
   ...
   - MINOR → new features / UX improvements (e.g., v0.2.0: responsive popup, spinner, fallback injection; v0.3.0: rules engine, meta/viewport detection, popup list, collapsible sections, severity, animations)
...
5. **Changelog**
   ...
   - For v0.3.0, document rules engine, new rules, popup result format, collapsible sections, severity, and animations
